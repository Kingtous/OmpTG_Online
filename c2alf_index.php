...
<html>
<head>
    <title>C to ALF Converter</title>
...
<body>
<h1>C to ALF Converter</h1>
<div class="agile-its">
    <h2>OpenMP C File Upload</h2>
    <div class="w3layouts">
        <strong>Convert Trimmed OMPi C Code into ALF Code using custom ALFBackend</strong>
        <br></br>
        <p>Please upload the trimmed OMPi C Code file to be analyzed (≤1MB)</p>
        <div class="photos-upload-view">
            <form id="upload" name="form_upload" method="POST" enctype="multipart/form-data" action="process/alf_show.php">
                <input type="hidden" id="MAX_FILE_SIZE" name="MAX_FILE_SIZE" value="1024000"/>
                <div class="agileinfo">
                    <input type="submit" class="choose" accept=".c" value="Choose C Code File.." >
                    <h3>OR</h3>
