...
<div class="agile-its">
    <h2>File Upload</h2>
    <div class="w3layouts">
        <strong>Convert ALF Code into Parrallel Control Flow Graph</strong>
        <br/>
        ...
        <div class="photos-upload-view">
            <form id="upload" name="form_upload" method="POST" enctype="multipart/form-data" action="process/pcfg_show.php">
