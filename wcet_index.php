...
<div class="agile-its">
    ...
    <div class="w3layouts">
        <p>Generate WCET Based on ALF Code (≤10MB)</p>
        <div class="photos-upload-view">
            <form id="upload" name="form_upload" method="POST" enctype="multipart/form-data" action="process/wcet_show.php">
...
<!--                    <div id="filedrag">drag and drop file here</div>-->
                    <input type="submit" name="file_submit" value="Generate WCET" disabled="disabled" onclick="
